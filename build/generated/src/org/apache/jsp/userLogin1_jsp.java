...
public final class userLogin1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    ResultSet rs = stmt.executeQuery("SELECT * from user WHERE userName='"+username1+"'and userPassword='"+password1+"'");
    ...
    while(rs.next())
    {
        ...
        if(un.equals("username1")==true && pw.equals("password1")==true)
        {
